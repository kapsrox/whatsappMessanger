		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					User Manager <small>Silver User</small>
					</h3>
						...
						<ul class="nav nav-tabs">
							...
							<li class="disabled disabledTab">
								<a href="#tab_1" data-toggle="tab">
									 Silver Users Additional Details
								</a>
							</li>
                            <?php
							}elseif($kk === true){
    ...
    ?> 
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group last">
										...
										<div class="col-md-9">
											<textarea class="form-control" rows="6" name="address"  cols="45"><?php echo $cat_sub['info_address']; ?></textarea>
											<div id="editor2_error">
											</div>
										</div>
									</div>
