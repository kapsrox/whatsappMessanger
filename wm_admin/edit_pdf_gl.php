			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
							<a href="user_edit_gl.php?id=<?php echo $pdf['user_id']; ?>">
								Edit User Info
							</a>
                            <i class="fa fa-angle-right"></i>
						</li>
                            ...
                            <div class="tab-pane active" id="tab_0">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-reorder"></i>Edit PDF/PPT Detail
										</div>
										<div class="tools">
							...
							<!-- BEGIN FORM-->
                                        <form ction="update_pdf.php?id=<?php echo $user_id;?>&plan_id=<?php echo $_REQUEST['plan_id']; ?>&info_id=<?php echo $pdf_id; ?>"  id="form_sample_1" enctype="multipart/form-data" class="form-horizontal" method="post">
                                            <div class="form-body">
												...
												$list= $admin->get_info_pdf_by_id($user_id);
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" name="name" data-required="1"  class="form-control" value="<?php echo $list['info_pdf']; ?>" disabled/>
                                                    </div>
                                                </div>
                                                <?php
		...
		$(function() {
			$('#file_upload1').uploadifive({
				...
				'onUploadComplete' : function(file, data) {
					console.log(data);
					window.location="edit_pdf_gl.php?id=<?php echo $_GET['id']; ?>&plan_id=<?php echo $plan_id;?>&info_id=<?php echo $pdf_id; ?>";
				}
			});
		});
	</script>
