...
$pdf_id = $_GET['info_id'];
$pdf = $admin->get_info_pdf_by_id($pdf_id);
?>
<!DOCTYPE html>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					User Manager <small><?php echo $cat['client_cat_name']; ?> Users</small>
					</h3>
				...
				<div class="col-md-12">
					<div class="tabbable tabbable-custom boxless tabbable-reversed">
						...
						<div class="tab-content">
							...
							<!-- BEGIN FORM-->
                                        <form ction="update_pdf.php?id=<?php echo $user_id;?>&plan_id=<?php echo $_REQUEST['plan_id']; ?>&info_id=<?php echo $pdf_id; ?>"  id="form_sample_1" enctype="multipart/form-data" class="form-horizontal" method="post">
                                            <div class="form-body">
												...
												$lists= $admin->get_info_pdf_by_id($user_id);
												
												?>
                                                
                                                <div class="form-group">
                                                    <label class="control-label col-md-3">PDF Name
                                                    <!--<span class="required">
                                                         *
                                                    </span>-->
                                                    </label>
                                                    <div class="col-md-4">
                                                        <input type="text" name="name" data-required="1"  class="form-control" value="<?php echo $lists['info_pdf']; ?>" disabled/>
                                                    </div>
                                                </div>
                                                <?php
                                               ...
                                               <input style="display:none;" id="uid3" type="text" name="plain_id" value="<?php echo  $pdf_id;?>">
                                               <div class="form-group">
...
<script type="text/javascript">
		$(function() {
			$('#file_upload1').uploadifive({
				'auto'         : false,
				'formData'     : {'userid': $("#uid1").val(), 'plan_id': $("#uid2").val(), 'info_id':$("#uid3").val() },
				'queueID'      : 'queue2',
				'uploadScript' : '../admin/update_pdf.php',
				'uploadLimit'  : 1,
				...
				'onUploadComplete' : function(file, data) {
					console.log(data);
					window.location="edit_pdf_pl.php?id=<?php echo $_GET['id']; ?>&plan_id=<?php echo $plan_id;?>&info_id=<?php echo $pdf_id; ?>";
				}
			});
		});
	</script>
