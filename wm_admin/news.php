					...
					<div class="tabbable tabbable-custom boxless tabbable-reversed">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab_0">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-reorder"></i>Add News
										</div>
										<div class="tools">
							...
							<!-- BEGIN FORM-->
                                        ...
                                        <form action="insert_news.php?id=<?php echo $user_id; ?>" id="form_sample_6" class="form-horizontal" method="post" enctype="multipart/form-data">
                                            <div class="form-body">
                                   ...
                                   <div class="form-group last">
										<label class="control-label col-md-3">News Description
										<span class="required">
											 *
										</span>
										</label>
                            ...
                            <div class="tab-pane" id="tab_1">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-reorder"></i>News List
										</div>
										<div class="tools">
											<a href="javascript:;" class="collapse">
											</a>
							...
							<tr class="odd gradeX">
								...
								<td>
									 <?php echo $list['n_title']; ?>
								</td>
								<td>
									<img src="../users_img/<?php echo $list['n_img']; ?>" width="100" height="100" />
								</td>
								<td>
									 <?php echo $list['n_desc']; ?>
								</td>
								<td class="center">
									 <?php echo date('d-m-Y',$list['n_timestamp']); ?>
								</td>
								
                                
                                <td>
                                <a href="edit_news.php?id=<?php echo $list['n_id'];?>" data-sfid='"<?php echo $list['n_id'];?>"' role="button" class="btn green edit" data-toggle="modal">
											 Edit News
										</a>
                                </td>
                                <td><a href="news_delete.php?id=<?php echo $list['n_id'];?>" class="btn green alert1">Delete Article</a></td>
							</tr>
							<?php
