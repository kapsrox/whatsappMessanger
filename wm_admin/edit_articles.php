					...
					<div class="tabbable tabbable-custom boxless tabbable-reversed">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab_0">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-reorder"></i>Edit Article's
										</div>
										<div class="tools">
							...
							<!-- BEGIN FORM-->
                                        ...
                                        <form action="update_articles.php?id=<?php echo $_REQUEST['id'] ?>" id="form_sample_6" class="form-horizontal" method="post" enctype="multipart/form-data">
                                            <div class="form-body">
                                               ...
                                               <?php
											   $at_id = $_REQUEST['id'];
                                               $lists = $admin->get_articles_by_id($at_id); 
                                               ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" name="subject" value="<?php echo $lists['at_title']; ?>"  class="form-control" />
                                                    </div>
                                                </div>
										...
										<div class="col-md-9">
											<div class="fileinput fileinput-new" data-provides="fileinput">
												<div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
													<img src="../users_img/<?php echo $lists['at_img']; ?>" alt=""/>
												</div>
                                   ...
                                   <div class="form-group last">
										...
										<div class="col-md-9">
											<textarea class="form-control" id="elm1" name="information"  rows="6" data-error-container="#editor3_error" > <?php echo $lists['at_desc']; ?></textarea>
