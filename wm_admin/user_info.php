					...
					<div class="tabbable tabbable-custom boxless tabbable-reversed">
						...
						<div class="tab-content">
							...
							<!-- BEGIN FORM-->
                                        ...
                                        ?>
                                        <form action="register_info.php?id=<?php echo $_GET['id'];?>&plan_id=<?php echo $_GET['plan_id']?>" id="form_sample_7" class="form-horizontal" method="post">
                                            <div class="form-body">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-md-9">
											<textarea class="form-control" id="elm1" name="information"  rows="6"></textarea>
                                    ...
                                    <div class="form-group last">
									  ...
									  <div class="form-group">
                                        ...
                                        <?php
										}elseif($_GET['plan_id'] == 4)
										{
										?>
                                        	
                                            <form action="register_info.php?id=<?php echo $_GET['id'];?>" id="form_sample_4" class="form-horizontal" method="post">
                                            <div class="form-body">
                                                <div class="alert alert-danger display-hide">
                                                    <button class="close" data-close="alert"></button>
                                                    You have some form errors. Please check below.
                                                ...
                                                <div class="form-group last">
										<label class="control-label col-md-3">Information & Address
										<span class="required">
											 *
										</span>
										</label>
										<div class="col-md-9">
											<textarea class="ckeditor form-control" name="address"  rows="6" data-error-container="#editor2_error"></textarea>
											<div id="editor2_error">
											</div>
										</div>
									</div>
                                        ...
                                        ?>
                                        <form action="register_silver.php?id=<?php echo $_GET['id'];?>&plan_id=<?php echo $_GET['plan_id']; ?>" id="form_sample_6" class="form-horizontal" method="post">
                                            <div class="form-body">
                                                <div class="alert alert-danger display-hide">
                                                    <button class="close" data-close="alert"></button>
                                                    You have some form errors. Please check below.
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <?php $cat = $admin->get_cat(); ?>
                                                        <select class="form-control" name="category" onChange="showCat(this.value)" id="category">
                                                            <option value="">Select...</option>
                                                            <?php
                                                            foreach($cat as $result)
                                                            {
                                                ...
                                                <div class="form-group">
													...
													<?php if($img == 5)
														{
													?>
                                            		<a class="disabling" style="position: relative; top: 8px;" href="javascript:$('#file_upload').uploadifive('upload')">Upload Files</a>
                                                    <?php
														}else {
													?>
...
<script type="text/javascript">
		$(function() {
			$('#file_upload').uploadifive({
				...
				'queueID'      : 'queue',
				'uploadScript' : '../admin/img_upload.php',
