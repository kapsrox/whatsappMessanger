					...
					<div class="tabbable tabbable-custom boxless tabbable-reversed">
						...
						<div class="tab-content">
							...
							<!-- BEGIN FORM-->
                                        ...
                                        ?>
                                        <form action="register_gl.php?id=<?php echo $_GET['id'];?>&plan_id=<?php echo $_GET['plan_id']; ?>" id="form_sample_6" class="form-horizontal" method="post">
                                            <div class="form-body">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-md-4">
										 ...
										 <span>Note :- Copy Only Src code Without Height & Width From Embed Code From Google Map</span></label>           
                                       </div>
                                    </div>
                            ...
                            <div <?php if($user_comp === true) { echo 'class="tab-pane active"';}else{ echo 'class="tab-pane "';} ?> id="tab_1">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
