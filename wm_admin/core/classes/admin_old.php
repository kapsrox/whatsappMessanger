...
LEFT JOIN categories ON categories.cat_id = company_info.cat_id WHERE users.user_id=?");
	...
	public function update_user_additional($user_id, $cat_id, $sub_id, $information,$add_info, $address,$landmark) {
		
		$query = $this->db->prepare("UPDATE company_info ci LEFT JOIN categories c ON ci.cat_id=c.cat_id LEFT JOIN subcategories s ON ci.subc_id=s.subc_id SET ci.cat_id=?, ci.subc_id=?, ci.info_information=?, ci.info_aditional=?,ci.info_landmark=?.ci.info_address=?  WHERE ci.user_id=?");
	...
	public function update_user_additional_other($user_id, $cat_id, $sub_id,  $url, $tube, $information, $prod_desc, $add_info, $address,$landmark) {
		//echo "hello";
		
		$query = $this->db->prepare("UPDATE company_info ci LEFT JOIN categories c ON ci.cat_id=c.cat_id LEFT JOIN subcategories s ON ci.subc_id=s.subc_id SET ci.cat_id=?, ci.subc_id=?, ci.info_url=?, ci.info_tube=?, ci.info_information=?,ci.info_aditional=?, ci.info_prod_desc=?,  ci.info_address=?,  ci.info_landmark=?  WHERE ci.user_id=?");
