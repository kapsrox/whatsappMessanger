				...
				<div class="col-md-12">
					<div class="tabbable tabbable-custom boxless tabbable-reversed">
						...
						<?php if($user_comp === true) { ?>	
							...
							if($_GET['plan_id'] !=1)
							{	if(($user_comp == true) &&($img == 5) && ($pdf == 1) && !empty($logo['logo_info'])){
						...
						<div class="tab-content">
							...
							<!-- BEGIN FORM-->
                                        ...
                                        ?>
                                        <form action="register_platinum.php?id=<?php echo $_GET['id'];?>&plan_id=<?php echo $_GET['plan_id']; ?>" id="form_sample_6" class="form-horizontal" method="post">
										<input type="hidden" value="admin" name="person_type">
										<input type="hidden" value="admin" name="person_name">
										<div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" name="url"  class="form-control" <?php if($user_comp === true) { echo "disabled";}else{ } ?> />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <textarea id="video_string_input" class="form-control" name="tube" <?php if($user_comp === true) { echo "disabled";}else{ } ?>></textarea>
                                   ...
                                   <div class="form-group">
										...
										<div class="col-md-9">
											<textarea class="form-control" id="elm1" name="information"  rows="6" data-error-container="#editor3_error" <?php if($user_comp === true) { echo "disabled";}else{ } ?>></textarea>
										<div id="editor1_error">
											</div>	
										</div>
									</div>
                                 <div class="form-group">
										<label class="control-label col-md-3">Addional Information
										<span class="required">
											 *
										</span>
										</label>
										<div class="col-md-9">
											<textarea class="form-control" id="elm3" name="Addition_information"  rows="6" data-error-container="#editor3_error"></textarea>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-md-9">
											<textarea class="form-control" id="elm2" name="prod_desc"  rows="6" <?php if($user_comp === true) { echo "disabled";}else{ } ?>></textarea>
                                    ...
                                    <div class="form-group last">
										...
										<div class="col-md-9">
											<textarea class="form-control" name="address"  rows="6" cols="45" <?php if($user_comp == true ) echo "disabled"; ?>></textarea>
							...
							?>
                            <div <?php if(($user_comp === true) && (($img != 5) || ($pdf != 1) || $logo['info_logo'] == 'images/nologo.png')) { echo 'class="tab-pane active"'; }elseif($user_comp === false){ echo 'class="tab-pane"';}elseif(($user_comp == true) &&($img == 5) && ($pdf == 1) && !empty($logo['info_logo'])){ echo "style='display:none;'";} ?>  id="tab_1">
...
<hr>
                                    ...
                                    <input style="display:none;" type="text" name="id" value="<?php echo  $_GET['id'];?>" id="uid3">
                                            	...
                                            	<div class="form-group">
													...
													<div id="queue2"></div>
													<input  id="file_upload2" name="file_upload2" type="file" multiple>
											
                                            		<?php if($pdf == 1)
													{
														?>
                                                    <a class="disabling" style="position: relative; top: 8px;" href="javascript:$('#file_upload2').uploadifive('upload')">Upload Files <?php echo '<span style="color:red;">(exceeded limit of uploading)</span>' ?></a>
                                                    <?php
													}else{
														?>
                            ...
                            <?php
							if(($user_comp == true) &&($img == 5) && ($pdf == 1) && !empty($logo['info_logo']) && $logo['info_logo'] != 'images/nologo.png'){
...
<script type="text/javascript">
		$(function() {
			$('#file_upload2').uploadifive({
				'auto'           : false,
				'k'              : <?php echo @$pdf['user_id']; ?>,
				'queueSizeLimit' : 1 - <?php echo @$pdf['user_id']; ?>,
