...
<div class="page-container">
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					User Manager <small> Gold User</small>
					</h3>
    ...
    ?> 
                                                    ...
                                                    <div class="col-md-4">
                                                       ...
                                                       <select class="form-control" multiple name="subcategory_multiple[]" id="subcategory_multiple">
																...
																foreach($val as $v):
                                                                    ...
                                                                    <option value="<?php echo $subs['subc_id'];?>" selected><?php echo $subs['subc_name'];?></option>
                                                                    </optgroup>
							...
							<tr class="odd gradeX">
                                ...
                                <td>
                                <a href="edit_pdf_gl.php?id=<?php echo $list['info_pdf_id'];?>&plan_id=<?php echo $list['plan_id'];?>&info_id=<?php echo $list['info_pdf_id']; ?>" data-sfid='"<?php echo $list['user_id'];?>"' role="button" class="btn green edit" data-toggle="modal">
											 Edit PDF/PPT
										</a>
                                </td>
