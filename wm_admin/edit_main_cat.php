		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					User Manager <small><?php echo "Edit Main Category"; ?> </small>
					</h3>
				...
				<div class="col-md-12">
					<div class="tabbable tabbable-custom boxless tabbable-reversed">
						...
						<div class="tab-content">
                            ...
                            <div class="tab-pane active" id="tab_0">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-reorder"></i>Category Info
										</div>
										<div class="tools">
                            ...
                            <!-- BEGIN FORM-->
							<form enctype="multipart/form-data" action="update_cat.php?id=<?php echo $_GET['id'];?>" method="post" class="form-horizontal form-bordered">
							 <?php
										$id = $_GET['id'];
										$lists = $users->get_cat($id);
								...
								<div class="form-body">
									...
									<div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" name="cat_name" data-required="1" value="<?php echo $lists['cat_name'];?>" class="form-control"/>
                                                    </div>
                                               </div>
										...
										<div class="col-md-9">
											<div class="fileinput fileinput-new" data-provides="fileinput">
												<div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
														<img src="../<?php echo $lists['cat_img']; ?>" alt=""/>
												</div>
